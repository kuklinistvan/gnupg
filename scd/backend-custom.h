...
gpg_error_t custom_cmd_lock (assuan_context_t ctx, char *line);
gpg_error_t custom_cmd_unlock (assuan_context_t ctx, char *line);
gpg_error_t custom_cmd_getinfo (assuan_context_t ctx, char *line);
gpg_error_t custom_cmd_restart (assuan_context_t ctx, char *line);
...
gpg_error_t custom_cmd_killscd (assuan_context_t ctx, char *line);
